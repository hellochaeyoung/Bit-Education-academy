...
<%
    ...
    List<BbsDto> list = (List<BbsDto>) object.get("list");
    int bbsPage = (int) object.get("bbsPage");
    int pageNumber = (int) object.get("pageNumber");
    String search = (String)object.get("search");
    String choice = (String)object.get("choice");
...
<table border="1">
    ...
    <%
            ...
            <tr>
                ...
                <td>
                    <%= arrow(bbs.getDepth())%>
                    <a href="<%= request.getContextPath()%>/bbs?param=bbsdetail&seq=<%= bbs.getSeq() %>"><%=bbs.getTitle() %></a>
                </td>
