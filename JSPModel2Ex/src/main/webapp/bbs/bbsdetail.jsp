...
<script type="text/javascript">
    ...
    function updateBtn() {
        location.href = "<%= request.getContextPath()%>/bbs?param=updateBbs&seq=" + <%= seq%>;
    }


    function deleteBtn() {
        location.href = "<%= request.getContextPath()%>/bbs?param=deleteBbs&seq=" + <%= seq%>;
    }

    function backBtn() {
        location.href = "<%= request.getContextPath()%>/bbs?param=bbslist";
    }

    function commentBtn() {
        location.href = "<%= request.getContextPath()%>/bbs?param=answer&seq=" + <%= seq%>;
    }
